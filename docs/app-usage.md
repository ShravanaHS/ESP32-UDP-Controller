...
- Download the final release APK from the GitHub releases page.
...
![Connection Screen](../assets/screenshots/connection_screen.png)

3. On the **Connection Screen**, enter the local IP address of your ESP32 (e.g., `192.168.1.100`).
4. Tap **Connect**. The app will validate the IP format and immediately open the dashboard.
...
![Controller UI Example](../assets/screenshots/controller_ui.png)
...
![Telemetry Panel](../assets/screenshots/telemetry_panel.png)
